        ...
        <div class="card-panel">
          ...
          <div class="row">
            <div class="row">
              ...
              <div class="col s12">
                <div class="col s12">
                  <ul class="tabs company-details-tab-box z-depth-1">
                    ...
                    if (@$this->property_module->is_view == 1) {
                    ?>
                      <li class="tab"><a class="tabclick" href="#imagetitle" title="Image Title">Image Title</a></li>
                    <?php
                    }
              ...
              <?php if (@$this->property_module->is_view == 1) { ?>
                <!-- Image Title Start -->
                      ...
                      <div class="row">
                        <div class="col s12">
                          <div class="row m-b-0">
                            ...
                            <div class="input-field col m2 s12">
                              <select id="PageSize" class="PageSize select_materialize" data-div="imagetitle">
                                <option value="10" selected>10</option>
                                <option value="20">20</option>
                                <option value="50">50</option>
                                <option value="100">100</option>
                            ...
                            ?>
                              <div class="col s12 m10 right-align list-page-right-top-icon">
                                <a href="<?php echo site_url("admin/project/imagetitle/add/" . $ProjectID); ?>" class="btn-floating right waves-effect waves-light green accent-6">
                                  <i class="mdi-content-add tooltipped" data-position="top" data-delay="50" data-tooltip="Add"></i>
                                </a>
                              </div>
                            <?php } ?>
