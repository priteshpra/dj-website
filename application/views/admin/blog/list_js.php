<script type="text/javascript">
    ...
    function common_ajax(current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/blog/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                BlogTitle: BlogTitle,
    ...
    $("#cms_table_body").on('click', '.status_change', function() {
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/blog/changeStatus",
            data: {
                id: id,
                status: status
            },
    ...
    $("#cms_table_body").on('click', '.info', function() { //$(".info").on('click', function () {
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/blog/getRecordInfo",
            data: {
                id: id,
