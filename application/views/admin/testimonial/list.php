    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12">
          <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/testimonial"><?php echo label('msg_lbl_title_test'); ?></a></h5>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="card-panel">
              ...
              <div class="row m-b-0">
                ...
                <div class="col s12 m4 right-align list-page-right-top-icon">
                  ...
                  <?php if (@$this->cur_module->is_insert == 1) { ?>
                    <a href="<?php echo site_url("admin/testimonial/add"); ?>" class="btn-floating right waves-effect waves-light green accent-6"><i class="mdi-content-add tooltipped" data-position="top" data-delay="50" data-tooltip="Add"></i></a>
                  <?php } ?>
                </div>
              </div>
            </div>
          ...
          <div class="table-responsive">
            <table id="data-table-row-grouping" class="display" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th><?php echo label('msg_lbl_pagenametest'); ?></th>
                  <th>Content</th>
