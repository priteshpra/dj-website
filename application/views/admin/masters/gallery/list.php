    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12">
          <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/masters/gallery">Artist Gallery</a></h5>
        </div>
      </div>
    </div>
  </div>
              ...
              <div class="row m-b-0">
                ...
                <div class="col s12 m4 right-align list-page-right-top-icon">
                  ...
                  <?php if (@$this->cur_module->is_export == 1) { ?>
                    <a href="<?php echo site_url("admin/masters/gallery/export_to_excel"); ?>" class="export-excel btn-floating  right waves-effect waves-light btn white-text"><i class="mdi-file-cloud-download tooltipped" data-position="top" data-delay="50" data-tooltip="Export Excel"></i></a>
                  <?php }
                  if (@$this->cur_module->is_insert == 1) { ?>
                    <a href="<?php echo site_url("admin/masters/gallery/add"); ?>" class="btn-floating right waves-effect waves-light green accent-6"><i class="mdi-content-add tooltipped" data-position="top" data-delay="50" data-tooltip="Add"></i></a>
                  <?php } ?>
                </div>
              </div>
            </div>
              ...
              <div class="search_action card-panel" style="display:none;">
                ...
                <div class="row m-b-0">
                  <div class="input-field col m6 s12">
                    <input type="text" name="Title" id="Title" maxlength="50" class="form-control LetterOnly">
                    <label>Title </label>
                  </div>
                </div>
                <div class="row m-b-0">
