<script type="text/javascript">
    ...
    function common_ajax(current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/gallery/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                Title: Title,
    ...
    $("#banner_table_body").on('click', '.status_change', function() {
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/gallery/changeStatus",
            data: {
                id: id,
                status: status
            },
    ...
    $("#banner_table_body").on('click', '.info', function() {
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/gallery/getRecordInfo",
            data: {
                id: id,
