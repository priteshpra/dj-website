    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12">
          <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/masters/section"><?php echo label('msg_lbl_title_section'); ?></a></h5>
        </div>
      </div>
    </div>
  </div>
              ...
              <div class="row m-b-0">
                ...
                <div class="col s12 m4 right-align list-page-right-top-icon">
                  ...
                  <?php if (@$this->cur_module->is_insert == 1) { ?>
                    <a href="<?php echo site_url("admin/masters/section/add"); ?>" class="btn-floating right waves-effect waves-light green accent-6"><i class="mdi-content-add tooltipped" data-position="top" data-delay="50" data-tooltip="Add"></i></a>
                  <?php } ?>
                </div>
              </div>
            </div>
