        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/masters/brand"><?php echo label('msg_lbl_title_brand'); ?></a></h5>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="row m-b-0">
                                ...
                                <div class="col s12 m4 right-align list-page-right-top-icon">
                                    ...
                                    <?php if (@$this->cur_module->is_export == 1) { ?>
                                        <a href="<?php echo site_url("admin/masters/brand/export_to_excel"); ?>" class="export-excel btn-floating  right waves-effect waves-light btn white-text"><i class="mdi-file-cloud-download tooltipped" data-position="top" data-delay="50" data-tooltip="Export Excel"></i></a>
                                    <?php }
                                    if (@$this->cur_module->is_insert == 1) { ?>
                                        <a href="<?php echo site_url("admin/masters/brand/add"); ?>" class="btn-floating right waves-effect waves-light green accent-6"><i class="mdi-content-add tooltipped" data-position="top" data-delay="50" data-tooltip="Add"></i></a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="search_action card-panel" style="display:none;">
                                ...
                                <div class="row m-b-0">
                                    <div class="input-field col s6 m6">
                                        <input type="text" name="BrandName" id="BrandName" maxlength="100" class="form-control LetterOnly">
                                        <label name="BrandName" class=""><?php echo label('msg_lbl_brand'); ?></label>
                                    </div>
                        ...
                        <div class="">
                            <table id="data-table-row-grouping" class="display " cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th><?php echo label('msg_lbl_brand'); ?></th>
