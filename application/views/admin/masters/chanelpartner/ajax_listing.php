<?php foreach ($chanelpartner as $chanelpartner) { ?>
    <tr class="gradeX" id="row_<?php echo $chanelpartner->ChanelPartnerID; ?>">
        ...
        <td align="center"><a class="txt-underline bold" href="<?php echo $this->config->item('base_url'); ?>admin/masters/ChanelPartner/familymembers/<?php echo $chanelpartner->ChanelPartnerID; ?>" ><?php echo $chanelpartner->FirstName." ".$chanelpartner->LastName; ?></a></td>
        ...
        <td align="center"><?php echo $chanelpartner->FamilyMemberCount; ?></td>
        <?php
