        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/masters/category"><?php echo label('msg_lbl_title_subcategory'); ?></a></h5>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="search_action card-panel" style="display:none;">
                                ...
                                <div class="row m-b-0">
                                    <div class="input-field col s6 m6">
                                        ...
                                        <label name="CategoryName" class=""><?php echo label('msg_lbl_subcategory'); ?></label>
                                    </div>
