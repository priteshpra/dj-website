                ...
                <form class="col s12" id="addCountryForm" method="post" action="<?php echo $this->config->item('base_url'); ?>admin/user/vendor/<?php echo $page_name; ?>">
                    ...
                    <div class="row">.
                        <div class="col s12 m3">
                            ...
                            <input type="date" name="BirthDate" id="BirthDate" value="<?php  echo @$vendor->BirthDate ; ?>">
                        </div>
                        <div class="input-field col s12 m3">
                        </div>
                        <div class="col s12 m3">
                            <label name="AnniversaryDate" class=""><?php echo label('msg_lbl_anniversarydate')?></label>
                            <input type="date" name="AnniversaryDate" id="AnniversaryDate" value="<?php  echo @$vendor->AnniversaryDate ; ?>">
                        </div>
