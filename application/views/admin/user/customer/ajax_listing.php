	...
	foreach ($data_array as $data) { ?>
		<tr id="row_<?php echo $data->CustomerID; ?>">
			...
			<td class="action center">
				...
				<a target="_blank" title="whatsapp" href="https://wa.me/+91<?php echo $data->MobileNo; ?>" class=" modal-trigger btn-floating waves-effect waves-light teal darken-1" data-id="<?php echo $data->CustomerID; ?>">
