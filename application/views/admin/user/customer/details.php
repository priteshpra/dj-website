        ...
        <div class="card-panel">  
          <div class="col s12 m12 l12 clearfix">
            ...
            <div class="right">
              ...
              ?>
              <!-- <a href="javascript:void(0)" data-id="<?php //echo $Customer->CustomerID;?>" data-type="Mail" data-user="Customer" class="reminderbtn btn-floating waves-effect waves-light orange accent-4">
              ...
              ?>
              <!-- <a href="javascript:void(0)" data-id="<?php //echo $Customer->CustomerID;?>" data-type="SMS" data-user="Customer" class="reminderbtn btn-floating waves-effect waves-light indigo">
