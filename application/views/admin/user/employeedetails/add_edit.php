                ...
                <form class="col s12" name="add_form" id="add_form" method="post" action="<?php echo $this->config->item('base_url'); ?>admin/user/employeedetails/<?php echo $page_name;?>">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <?php }?>
                                <input name="Email" id="Email" type="email" maxLength="250" value="<?php echo @$employee->EmailID; ?>" <?php if(isset($employee->UserID)){ echo 'readonly';}else{echo '';} ?>/> 
                    ...
                    <div class="row">.
                        ...
                        <div class="col s12 m3">
                            ...
                            <input type="date" name="AnniversaryDate" id="AnniversaryDate" value="<?php  echo @$employee->AnniversaryDate ; ?>">
                        </div>
