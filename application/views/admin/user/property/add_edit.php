    ...
    <div class="container">
        <div class="card-panel col s12">
            <h4 class="header m-t-0">
                <a href="<?php if($CustomerID!='-1'){ echo site_url('admin/user/customer/details/'.$CustomerID . '#property'); } else{ echo '#'; } ?>"><strong>Customer Property</strong>
                </a>
            </h4>        
            <div class="row">
                <form class="col s12" method="post" action="<?php echo $this->config->item('base_url'); ?>admin/user/property/<?php echo $Page;?>">
                    ...
                    <div class="row">
                        <div class="input-field col s12 m6">
                            ...
                            <input id="Amount" name="Amount" value="<?php echo isset($data->Amount)?($data->Amount):'';?>" type="text"  maxlength="9" class="NumberOnly empty_validation_class" <?php echo (@$data->TotalNoOfPayment>0)?'disabled':'';?>/>
                    ...
                    <div class="row">
                         <div class="col s6">
                            ...
                            <input type="date" name="PurchaseDate" id="PurchaseDate" value="<?php echo isset($data->PurchaseDate)? $data->PurchaseDate:date('d-m-Y');?>" class="empty_validation_class">
                        </div>
                        <div class="input-field col s12 m6">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s3">
                            <input type="checkbox" class=""  name="IsHold" id="IsHold"   
                            <?php
                        ...
                        <div class="input-field col s6">
                            ...
                            <a  href="<?php if($CustomerID!='-1'){ echo site_url('admin/user/customer/details/'.$CustomerID. '#property'); } else{ echo site_url('admin/user/visitor/details/'.$VisitorID); } ?>" class="right close-button">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
