          ...
          <div class="row m-t-20">
            <div class="row">
              <div class="col s12">
                <div class="col s12">
                  <ul class="tabs company-details-tab-box z-depth-1">
                    ...
                    if (@$this->document_module->is_view == 1) {
                    ?>
                      <li class="tab"><a class="tabclick" href="#propertyimage" title="Property Image">Property Image</a></li>
                    <?php
                    }
                    if (@$this->document_module->is_view == 1) {
                    ?>
                      <li class="tab"><a class="tabclick" href="#video" title="Video">Video</a></li>
                    <?php
                    }
              ...
              ?>
                ...
                <!-- Customer propertyimage Start -->
                <div id="propertyimage" class="col s12">
                  <div class="col s12 m12 l12">
                    <div class="card-panel">
                      <div class="row">
                        <div class="col s12">
                          <div class="row m-b-0">
                            ...
                            ?>
                              <div class="col s12 m10 right-align list-page-right-top-icon">
                                <a href="<?php echo site_url("admin/user/document/addImage/" . $CustomerPropertyID); ?>" class="btn-floating right waves-effect waves-light green accent-6">
                                  <i class="mdi-content-add tooltipped" data-position="top" data-delay="50" data-tooltip="Add"></i>
                                </a>
                              </div>
                            <?php } ?>
