        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/user/visitor/withoutfiltervisitor"><?php echo label('msg_lbl_title_visitor'); ?></a></h5>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="search_action card-panel" style="display:none;">
                                ...
                                <div class="row m-b-0">
                                    ...
                                    <div class="col s12 m6">
                                        <label for="EntryDate">Entry From Date</label>
                                        <input id="EntryFromDate" name="EntryFromDate" type="date" class=" EntryFromDate" maxlength="13" />
                                    </div>
                                    <div class="col s12 m6">
                                        <label for="EntryDate">Entry To Date</label>
                                        <input id="EntryToDate" name="EntryToDate" type="date" class=" EntryToDate" maxlength="13" />
                                    </div>
                                </div>
                                <div class="row m-b-0">
                                    <div class="input-field col s12 m6">
                        ...
                        <table id="data-table-row-grouping" class="display " cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="width_180">Entry Date Time</th>
                                    ...
                                    <th class="width_130"><?php echo label('msg_lbl_title_visitorsites'); ?></th>
                                    <th class="width_130"><?php echo label('msg_lbl_requirement'); ?></th>
                                    <th class="width_130"><?php echo label('msg_lbl_budget'); ?></th>
                                    <th class="width_130"><?php echo label('msg_lbl_property_interest'); ?></th>
