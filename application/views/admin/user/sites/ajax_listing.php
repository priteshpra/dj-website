<?php foreach ($visitorsites as $data) { ?>
    <tr class="gradeX" id="row_<?php echo $data->VisitorSitesID; ?>">
        ...
        <td><?php echo $data->ChanelPartnerName; ?></td>
		<td><?php echo $data->VisitorCenter; ?></td>
		<td><?php echo $data->OutDoorLocation; ?></td>
		<td><?php echo $data->EntryDate; ?></td>
		<td><?php echo $data->Finance; ?></td>
		<td><?php echo $data->PropertyInterest; ?></td>
		...
		<td><?php echo $data->RefName; ?></td>
		<td><?php echo $data->RefMobileNo; ?></td>
		<?php
