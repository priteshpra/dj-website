                      ...
                      <table id="data-table-row-grouping" class="display " cellspacing="0" width="100%">
                        <thead>
                          <tr>
                            ...
                            <th class="width_130"><?php echo label('msg_lbl_chanel_partnersname') ?></th>
                            <th class="width_130"><?php echo label('msg_lbl_withinpremises') ?></th>
                            <th class="width_130"><?php echo label('msg_lbl_outdoorlocation') ?></th>
                            <th class="width_130"><?php echo label('msg_lbl_entrydatetime') ?></th>
                            <th class="width_130"><?php echo label('msg_lbl_finance') ?></th>
                            <th class="width_130"><?php echo label('msg_lbl_purposebuying') ?></th>
                            <th class="width_130"><?php echo label('msg_lbl_propertyinterest') ?></th>
                            ...
                            <th class="width_130"><?php echo label('msg_lbl_refname') ?></th>
                            <th class="width_130"><?php echo label('msg_lbl_refmobileno') ?></th>
                        ...
                        <table id="data-table-row-grouping" class="display " cellspacing="0" width="100%">
                          <thead>
                            <tr>
                              ...
                              <th class="width_130"><?php echo label('msg_lbl_message') ?></th>
                              <th class="width_130"><?php echo label('msg_lbl_mobileno') ?></th>
