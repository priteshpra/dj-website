    ...
    <div class="container">
        <div class="card-panel col s12">
            <h4 class="header m-t-0">
                <a href="<?php echo base_url('admin/user/visitor/details/'. $VisitorID."#reminder");?>"><strong><?php echo label('msg_lbl_title_visitoreminder')?></strong>
                </a>
            </h4>        
            <div class="row">
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                        <div class="col s6">
                            ...
                            <label name="ReminderDate" class=""><?php echo label('msg_lbl_reminderdate')?></label>
                            <input type="date" name="ReminderDate" id="ReminderDate" value="<?php echo isset($data->ReminderDate)? GetDateTimeInFormat(@$data->ReminderDate,DATABASE_DATE_TIME_FORMAT,DATABASE_DATE_FORMAT):"";?>" class=" empty_validation_class">
                        </div>
