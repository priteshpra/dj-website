                ...
                <form class="col s12" id="addStateForm" method="post" action="<?php echo $this->config->item('base_url'); ?>admin/user/visitor/<?php echo $page_name; ?>">
                    ...
                    <div class="row">.
                        <div class="col s12 m2">
                            ...
                            <input type="date" name="BirthDate" id="BirthDate" value="<?php echo @$visitor->BirthDate; ?>">
                        </div>
                        <div class="input-field col s12 m5">
                        </div>
                        <div class="col s12 m2">
                            <label name="AnniversaryDate" class=""><?php echo label('msg_lbl_anniversarydate') ?></label>
                            <input type="date" name="AnniversaryDate" id="AnniversaryDate" value="<?php echo @$visitor->AnniversaryDate; ?>">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <a href="<?php echo $this->config->item('base_url'); ?>admin/user/visitor/withoutfiltervisitor" class="right close-button"><?php echo label('msg_lbl_cancel'); ?></a>
                        </div>
                    </div>
                </form>
            </div>
