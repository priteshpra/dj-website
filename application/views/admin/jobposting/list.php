        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/jobposting"><?php echo label('msg_lbl_title_job'); ?></a></h5>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row m-b-0">
                                ...
                                <div class="col s12 m4 right-align list-page-right-top-icon">
                                    ...
                                    <?php if (@$this->cur_module->is_export == 1) { ?>
                                        <a href="<?php echo site_url("admin/jobposting/export_to_excel"); ?>" class="export-excel btn-floating  right waves-effect waves-light btn white-text"><i class="mdi-file-cloud-download tooltipped" data-position="top" data-delay="50" data-tooltip="Export Excel"></i></a>
                                    <?php }
                                    if (@$this->cur_module->is_insert == 1) { ?>
                                        <a href="<?php echo site_url("admin/jobposting/add"); ?>" class="btn-floating right waves-effect waves-light green accent-6"><i class="mdi-content-add tooltipped" data-position="top" data-delay="50" data-tooltip="Add"></i></a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
