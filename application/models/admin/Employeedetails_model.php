...
class Employeedetails_model extends CI_Model {
    ...
    public function update($array){
        ...
        $array['BirthDate']   =  getStringClean((isset($array['BirthDate']))?$array['BirthDate']:'0000:00:00'); 
        $array['AnniversaryDate']   =  getStringClean((isset($array['AnniversaryDate']))?$array['AnniversaryDate']:'0000:00:00'); 
