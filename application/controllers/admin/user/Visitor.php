...
class Visitor extends Admin_Controller {
    ...
    public function withoutfilterajax_listing($per_page_record = 10, $page_number = 1)
    {
        ...
        if (isset($result['visitor'][0]->Message))
            ...
            $result['total_records'] = isset($result['visitor'][0]) ? $result['visitor'][0]->rowcount : 0;
        ...
        try {
            ...
            if ($this->input->post()) {
                ...
                if ($this->form_validation->run() == TRUE) {
                    ...
                    if (@$res->ID) {
                        redirect($this->config->item('base_url') . 'admin/user/visitor/withoutfiltervisitor');
    ...
    public function export_to_excel() {
        ...
        //$res['visitor'] = $this->visitor_model->withoutFilterlistData(-1, 1);
        $_POST['LeadType'] =  'All';
        $_POST['DesignationID'] =  -1;
        $_POST['EmployeeID'] =  -1;
        $res['visitor'] = $this->visitor_model->withoutFilterlistData(-1, 1);
        ...
        $fields = array("SrNo", "EmployeeName","FirstName","LastName","EmailID","MobileNo","Address","CompanyName","SitesCount","Requirement","Budget","PropertyInterest"); 
        //Header Define
    ...
    public function export_to_excel_copy() {
        $_POST['LeadType'] =  'All';
        $_POST['DesignationID'] =  -1;
        $_POST['EmployeeID'] =  -1;
        $res['visitor'] = $this->visitor_model->withoutFilterlistData(-1, 1);
