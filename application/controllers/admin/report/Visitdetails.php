...
class Visitdetails extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/report/visitdetails/list', $array);
        $data['page_level_js'] = $this->load->view('admin/report/visitdetails/list_js', NULL, TRUE);
    ...
    public function ajax_listing($PageSize = 10, $CurrentPage = 1)
    {
        ...
        $res['data_array'] = $this->report_model->VisitDetailsListData($PageSize, $CurrentPage);
        ...
        if ($res['total_records'] != 0) {
            ...
            $ajax_listing = $this->load->view('admin/report/visitdetails/ajax_listing', $res, TRUE);
    ...
    public function export_to_excel()
    {
        ...
        $array['data'] = $this->report_model->VisitDetailsListData(-1, 1);
