...
class Channelpartner extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/report/channelpartner/list', $res);
        $data['page_level_js'] = $this->load->view('admin/report/channelpartner/list_js', NULL, TRUE);
        $data['footer']['add_link'] = $this->config->item('base_url') . 'admin/report/channelpartner/add';
    ...
    public function ajax_listing($per_page_record = 10, $page_number = 1)
    {
        ...
        $result['visitor'] = $this->report_model->ChannelpartnetListData($per_page_record, $page_number);
        ...
        if ($result['total_records'] != 0) {
            ...
            $ajax_listing = $this->load->view('admin/report/channelpartner/ajax_listing', $result, TRUE);
