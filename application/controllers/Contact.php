...
class Contact extends CI_Controller
{
    ...
    public function sendEmail()
    {
        ...
        if ($this->form_validation->run() == FALSE || !$response['success']) {
            ...
            <p><b>File Url: </b><a href="' . base_url("assets/uploads/resume/") . (isset($formData['filename']) ? $formData['filename'] : '') . '">' . (isset($formData['filename']) ? $formData['filename'] : '') . '</a></p>
            ...
            if ($send) {
                ...
                // $this->db1->insert('unregister_user', [
